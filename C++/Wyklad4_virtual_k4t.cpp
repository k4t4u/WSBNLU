...
class Pracownik: public Osoba 
{
    ...
    public:
        ...
        //Funkcja drukuj jest wirtualna poniewaz w klasie ksiegowosc funkcja drukujPit wywoluje te funkcje i ma byc wywolana z tej klasy z ktorej reprezentuje obiekt. (np. dla PracownikEtatowy pranownikaEtatowego)
        ...
        //Funkcja dochodyRoczne jest wirtualna poniewaz w klasie ksiegowosc funkcja drukujPit wywoluje te funkcje i ma byc wywolana z tej klasy z ktorej reprezentuje obiekt. (np. dla PracownikEtatowy pranownikaEtatowego)
