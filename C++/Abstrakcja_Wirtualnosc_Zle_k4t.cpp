...
#include <iostream>
using namespace std;
// Przyklad wirtualnosci i klasy abstrakcyjnej. Oto kod zbudowany bez virtualnosci. Dziala on nieprawidlowo poniewaz dla kazdej z umow (umowa, umowa zlecenie, umowa autorska) wywoluje funkcje ObliczPodatek z klasy Umowa.
class Data
{
    private:
        int dzien;
